...
wget https://www.python.org/ftp/python/3.7.17/Python-3.7.17.tar.xz && tar -xvf Python-3.7.17.tar.xz && cd Python-3.7.17
./configure
make&& make install
cd ..
rm -rf Python-3.7.17 Python-3.7.17.tar.xz
