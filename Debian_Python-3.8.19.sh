...
wget https://www.python.org/ftp/python/3.8.19/Python-3.8.19.tar.xz && tar zxvf Python-3.8.19.tar.xz && cd Python-3.8.19
./configure
make&& make install
cd ..
rm -rf Python-3.8.19 Python-3.8.19.tar.xz